                ...
                <tr
                    ...
                    <td class="px-6 py-4">
                        ...
                        <div class="flex flex-wrap justify-start gap-4">
                            ...
                            <div>
                                <svg class="inline-block w-8 h-8 text-green-500 dark:text-white" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 24 24">
                                ...
                                <a href="https://wa.me/{{ $pasien->pemeriksaan->dokter->no_telepon_dokter }}"
                                    class="underline text-green-500 text-xl">Tanya Dokter</a>
                            </div>
                        </div>
                        @else
                        {{-- Menunggu --}}
