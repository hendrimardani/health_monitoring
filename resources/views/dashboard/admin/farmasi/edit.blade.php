...
<form action="/dashboard/admin/farmasi/{{ $farmasi->id }}" method="post" class="mt-5">
    @csrf
    @method('PUT')
    <div class="mb-5">
        <input type="text" id="nama_perusahaan"
            ...
            placeholder="Nama Perusahaan" name="nama_perusahaan" value="{{ $farmasi->nama_perusahaan }}" autofocus
            required />
    </div>
    ...
    <div class="mb-5">
        <input type="text" id="alamat_perusahaan"
            class="border border-[#183e9f] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[500px] p-2.5"
            placeholder="Alamat Perusahaan" name="alamat_perusahaan" value="{{ $farmasi->alamat_perusahaan }}" autofocus
            required />
    </div>
