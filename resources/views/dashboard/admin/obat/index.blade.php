...
<div class="relative overflow-x-auto mt-5 overflow-hidden">
                        ...
                        <div
                            ...
                            <form action="{{ route('obat.destroy', $obat->id) }}" method="POST">
                                ...
                                <button type="button" data-modal-target="delete-modal" data-modal-toggle="delete-modal"
                                    data-id="{{ $obat->id }}" class="delete-button">
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('confirm-delete').addEventListener('click', () => {
            if (deleteId) {
                ...
                form.method = 'POST';
                form.action = `/dashboard/admin/obat/${deleteId}`;
                form.innerHTML = `
                    @csrf
                    @method('DELETE')
                `;
