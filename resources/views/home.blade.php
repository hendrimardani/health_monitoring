...
@section('container')
<div class="w-[1440px] h-[4608px] relative bg-white">
  <svg width="1009" height="1214" viewBox="0 0 1009 1214" fill="none" xmlns="http://www.w3.org/2000/svg"
    class="absolute left-[792px] top-[218px]" preserveAspectRatio="none">
    <g filter="url(#filter0_f_106_44)">
      <ellipse cx="697" cy="535.5" rx="335" ry="316.5" fill="#587DFF"></ellipse>
    </g>
    <defs>
      <filter id="filter0_f_106_44" x="0.200012" y="-142.8" width="1393.6" height="1356.6" filterUnits="userSpaceOnUse"
        color-interpolation-filters="sRGB">
        <feFlood flood-opacity="0" result="BackgroundImageFix"></feFlood>
        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"></feBlend>
        <feGaussianBlur stdDeviation="180.9" result="effect1_foregroundBlur_106_44"></feGaussianBlur>
      </filter>
    </defs>
  </svg><svg width="748" height="1243" viewBox="0 0 748 1243" fill="none" xmlns="http://www.w3.org/2000/svg"
    class="absolute left-[1053px] top-[670px]" preserveAspectRatio="none">
    <g filter="url(#filter0_f_106_45)">
      <ellipse cx="629" cy="621.5" rx="267" ry="259.5" fill="#183E9F"></ellipse>
    </g>
    <defs>
      <filter id="filter0_f_106_45" x="0.200012" y="0.200012" width="1257.6" height="1242.6"
        filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
        <feFlood flood-opacity="0" result="BackgroundImageFix"></feFlood>
        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"></feBlend>
        <feGaussianBlur stdDeviation="180.9" result="effect1_foregroundBlur_106_45"></feGaussianBlur>
      </filter>
    </defs>
  </svg><svg width="609" height="1200" viewBox="0 0 609 1200" fill="none" xmlns="http://www.w3.org/2000/svg"
    class="absolute left-[-249px] top-[1732px]" preserveAspectRatio="none">
    <g filter="url(#filter0_f_106_46)">
      <ellipse cx="-0.5" cy="600" rx="247.5" ry="238" fill="#587DFF"></ellipse>
    </g>
    <defs>
      <filter id="filter0_f_106_46" x="-609.8" y="0.200012" width="1218.6" height="1199.6" filterUnits="userSpaceOnUse"
        color-interpolation-filters="sRGB">
        <feFlood flood-opacity="0" result="BackgroundImageFix"></feFlood>
        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"></feBlend>
        <feGaussianBlur stdDeviation="180.9" result="effect1_foregroundBlur_106_46"></feGaussianBlur>
      </filter>
    </defs>
  </svg><svg width="609" height="1243" viewBox="0 0 609 1243" fill="none" xmlns="http://www.w3.org/2000/svg"
    class="absolute left-[-288px] top-[1152px]" preserveAspectRatio="none">
    <g filter="url(#filter0_f_106_47)">
      <ellipse cx="-20" cy="621.5" rx="267" ry="259.5" fill="#183E9F"></ellipse>
    </g>
    <defs>
      <filter id="filter0_f_106_47" x="-648.8" y="0.200012" width="1257.6" height="1242.6" filterUnits="userSpaceOnUse"
        color-interpolation-filters="sRGB">
        <feFlood flood-opacity="0" result="BackgroundImageFix"></feFlood>
        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"></feBlend>
        <feGaussianBlur stdDeviation="180.9" result="effect1_foregroundBlur_106_47"></feGaussianBlur>
      </filter>
    </defs>
  </svg><svg width="748" height="1483" viewBox="0 0 748 1483" fill="none" xmlns="http://www.w3.org/2000/svg"
    class="absolute left-[1053px] top-[1590px]" preserveAspectRatio="none">
    <g filter="url(#filter0_f_106_48)">
      <ellipse cx="745.5" cy="741.5" rx="383.5" ry="379.5" fill="#183E9F"></ellipse>
    </g>
    <defs>
      <filter id="filter0_f_106_48" x="0.200012" y="0.200012" width="1490.6" height="1482.6"
        filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
        <feFlood flood-opacity="0" result="BackgroundImageFix"></feFlood>
        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"></feBlend>
        <feGaussianBlur stdDeviation="180.9" result="effect1_foregroundBlur_106_48"></feGaussianBlur>
      </filter>
    </defs>
  </svg><svg width="682" height="998" viewBox="0 0 682 998" fill="none" xmlns="http://www.w3.org/2000/svg"
    class="absolute left-[-215px] top-[116px]" preserveAspectRatio="none">
    <g filter="url(#filter0_f_106_49)">
      <ellipse cx="53" cy="376.5" rx="267" ry="259.5" fill="#183E9F"></ellipse>
    </g>
    <defs>
      <filter id="filter0_f_106_49" x="-575.8" y="-244.8" width="1257.6" height="1242.6" filterUnits="userSpaceOnUse"
        color-interpolation-filters="sRGB">
        <feFlood flood-opacity="0" result="BackgroundImageFix"></feFlood>
        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"></feBlend>
        <feGaussianBlur stdDeviation="180.9" result="effect1_foregroundBlur_106_49"></feGaussianBlur>
      </filter>
    </defs>
  </svg><svg width="1029" height="1275" viewBox="0 0 1029 1275" fill="none" xmlns="http://www.w3.org/2000/svg"
    class="absolute left-[92px] top-[358px]" preserveAspectRatio="none">
    <g filter="url(#filter0_f_106_50)">
      <ellipse cx="380" cy="636" rx="287" ry="277" fill="#587DFF"></ellipse>
    </g>
    <defs>
      <filter id="filter0_f_106_50" x="-268.8" y="-2.79999" width="1297.6" height="1277.6" filterUnits="userSpaceOnUse"
        color-interpolation-filters="sRGB">
        <feFlood flood-opacity="0" result="BackgroundImageFix"></feFlood>
        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"></feBlend>
  ...
  <div class="w-[818px] h-[189px]">
    ...
    <p class="w-[818px] h-[83px] absolute left-[311px] top-[524px] text-4xl font-bold text-center text-black">
  ...
  <div class="w-[837px] h-[377px]">
    ...
    <p class="w-[661px] h-[168px] absolute left-[389px] top-[1622px] text-[64px] font-bold text-center text-black">
      <span class="w-[661px] h-[168px] text-[64px] font-bold text-center text-black">Pengguna </span><br /><span
        class="w-[661px] h-[168px] text-[64px] font-bold text-center text-black">Mempercayai Kami
      </span>
    </p>
    <p class="w-[837px] h-[147px] absolute left-[301px] top-[1475px] text-9xl font-bold text-left text-black">
      1.000.000++
    </p>
  </div>
  ...
  <svg width="469" height="43" viewBox="0 0 469 43" fill="none" xmlns="http://www.w3.org/2000/svg"
    ...
    <g clip-path="url(#clip0_106_98)">
      <path
        d="M21 3.87395C26.6072 3.87395 27.2714 3.8958 29.4857 3.99924C31.5332 4.09491 32.6451 4.44516 33.3852 4.73952C34.3653 5.12954 35.065 5.59552 35.7998 6.34783C36.5346 7.10014 36.9897 7.81644 37.3706 8.81991C37.6582 9.5776 38.0003 10.716 38.0938 12.8122C38.1948 15.0793 38.2161 15.7593 38.2161 21.5C38.2161 27.2408 38.1948 27.9208 38.0938 30.1878C38.0003 32.2841 37.6582 33.4225 37.3706 34.1802C36.9897 35.1836 36.5346 35.8999 35.7998 36.6523C35.065 37.4046 34.3653 37.8705 33.3852 38.2605C32.6451 38.5549 31.5332 38.9052 29.4857 39.0008C27.2717 39.1043 26.6076 39.1261 21 39.1261C15.3924 39.1261 14.7282 39.1043 12.5142 39.0008C10.4667 38.9052 9.35478 38.5549 8.6148 38.2605C7.63457 37.8705 6.93494 37.4046 6.20012 36.6523C5.46531 35.8999 5.01016 35.1836 4.62929 34.1802C4.3417 33.4225 3.9996 32.2841 3.90615 30.1879C3.80512 27.9208 3.78378 27.2408 3.78378 21.5C3.78378 15.7593 3.80512 15.0793 3.90615 12.8122C3.9996 10.716 4.3417 9.5776 4.62929 8.81991C5.01016 7.81644 5.46531 7.10014 6.20012 6.34783C6.93494 5.59552 7.63457 5.12954 8.6148 4.73952C9.35478 4.44516 10.4667 4.09491 12.5141 3.99924C14.7286 3.8958 15.3927 3.87395 21 3.87395ZM21 0C15.2967 0 14.5816 0.0247499 12.3417 0.129382C10.1064 0.233844 8.57996 0.59724 7.24412 1.12876C5.86318 1.67821 4.69206 2.41337 3.52461 3.60862C2.35716 4.80386 1.6391 6.00287 1.10243 7.41668C0.583267 8.78433 0.228322 10.3472 0.12629 12.6357C0.0240909 14.9288 0 15.661 0 21.5C0 27.3391 0.0240909 28.0713 0.12629 30.3644C0.228322 32.6529 0.583267 34.2158 1.10243 35.5834C1.6391 36.9971 2.35716 38.1962 3.52461 39.3915C4.69206 40.5867 5.86318 41.3219 7.24412 41.8713C8.57996 42.4028 10.1064 42.7662 12.3417 42.8707C14.5816 42.9753 15.2967 43 21 43C26.7033 43 27.4184 42.9753 29.6582 42.8707C31.8935 42.7662 33.42 42.4028 34.7558 41.8713C36.1367 41.3219 37.3079 40.5867 38.4753 39.3915C39.6428 38.1962 40.3608 36.9972 40.8975 35.5834C41.4166 34.2158 41.7716 32.6529 41.8736 30.3644C41.9758 28.0713 42 27.3391 42 21.5C42 15.661 41.9758 14.9288 41.8736 12.6357C41.7716 10.3472 41.4166 8.78433 40.8975 7.41668C40.3608 6.00287 39.6428 4.80386 38.4753 3.60862C37.3079 2.41337 36.1367 1.67821 34.7558 1.12876C33.42 0.59724 31.8935 0.233844 29.6582 0.129382C27.4184 0.0247499 26.7033 0 21 0ZM21 10.4595C15.0442 10.4595 10.2161 15.4025 10.2161 21.5C10.2161 27.5976 15.0442 32.5406 21 32.5406C26.9557 32.5406 31.7838 27.5976 31.7838 21.5C31.7838 15.4025 26.9557 10.4595 21 10.4595ZM21 28.6668C17.134 28.6668 13.9999 25.4581 13.9999 21.5C13.9999 17.542 17.134 14.3333 21 14.3333C24.8659 14.3333 28 17.542 28 21.5C28 25.4581 24.8659 28.6668 21 28.6668ZM34.7298 10.0233C34.7298 11.4482 33.6016 12.6033 32.2098 12.6033C30.8181 12.6033 29.6898 11.4482 29.6898 10.0233C29.6898 8.59836 30.8181 7.44331 32.2098 7.44331C33.6016 7.44331 34.7298 8.59836 34.7298 10.0233Z"
        fill="white"></path>
    </g>
    <path
      d="M119.404 23.554V15.5333H125.873V11.5C125.873 8.58756 126.817 6.11088 128.707 4.066C130.597 2.02244 132.887 1 135.574 1H142V9.022H135.574C135.155 9.022 134.777 9.253 134.441 9.715C134.105 10.177 133.937 10.744 133.937 11.416V15.532H142V23.5527H133.936V43H125.872V23.554H119.404Z"
      fill="white"></path>
    ...
    <g clip-path="url(#clip3_106_98)">
      <path
        d="M465.291 1H431.709C429.661 1 428 2.701 428 4.79924V39.2006C428 41.299 429.661 43 431.709 43H465.291C467.34 43 469 41.299 469 39.2006V4.79924C469 2.701 467.34 1 465.291 1ZM440.687 37.2656C440.687 37.8762 440.204 38.3712 439.608 38.3712H435.013C434.417 38.3712 433.934 37.8762 433.934 37.2656V17.5365C433.934 16.9258 434.417 16.4308 435.013 16.4308H439.608C440.204 16.4308 440.687 16.9258 440.687 17.5365V37.2656ZM437.311 14.5711C434.9 14.5711 432.946 12.5692 432.946 10.0999C432.946 7.63061 434.9 5.6288 437.311 5.6288C439.721 5.6288 441.675 7.63061 441.675 10.0999C441.675 12.5692 439.721 14.5711 437.311 14.5711ZM464.697 37.3546C464.697 37.916 464.253 38.3712 463.705 38.3712H458.775C458.227 38.3712 457.782 37.916 457.782 37.3546V28.1006C457.782 26.7201 458.178 22.0511 454.261 22.0511C451.222 22.0511 450.606 25.2469 450.482 26.681V37.3546C450.482 37.916 450.038 38.3712 449.49 38.3712H444.721C444.173 38.3712 443.729 37.916 443.729 37.3546V17.4474C443.729 16.886 444.173 16.4308 444.721 16.4308H449.49C450.038 16.4308 450.482 16.886 450.482 17.4474V19.1686C451.609 17.4366 453.283 16.0998 456.848 16.0998C464.742 16.0998 464.697 23.6549 464.697 27.8061V37.3546Z"
        fill="white"></path>
    </g>
    <defs>
      ...
      <clipPath id="clip1_106_98">
        <rect width="51" height="42" fill="white" transform="translate(200 1)"></rect>
      </clipPath>
      <clipPath id="clip2_106_98">
        <rect width="61" height="43" fill="white" transform="translate(309)"></rect>
      </clipPath>
      <clipPath id="clip3_106_98">
        <rect width="41" height="42" fill="white" transform="translate(428 1)"></rect>
      </clipPath>
    </defs>
  </svg>
